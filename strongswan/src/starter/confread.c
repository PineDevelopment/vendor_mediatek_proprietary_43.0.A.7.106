...
#ifdef STRONGSWAN_UNIT_TEST
	cfg->conn_default.left.ikeport = get_ut_ikev2_udp_port();
	cfg->conn_default.right.ikeport = get_ut_target_ikev2_udp_port();
#else
...
#ifdef STRONGSWAN_UNIT_TEST
	cfg->conn_default.left.ikeport_natt = get_ut_ikev2_udp_natt_port();
	cfg->conn_default.right.ikeport_natt = get_ut_target_ikev2_udp_natt_port();
#else
